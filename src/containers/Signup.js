...
class RegistrationForm extends React.Component {
  ...
  handleSubmit = e => {
    ...
    const { username, email, password1, password2, is_student} = this.state;
  ...
  handleChange2 = (e,data) => {
    console.log("Test: " + data.value + data.name)
    if(data.value === "true"){
          ...
          <React.Fragment>
            <Form size="large" onSubmit={this.handleSubmit}>
              <Segment stacked>
                ...
                options={[{value:"true", text:"Student"},{value:"false", text:"Teacher"}]}
                type = "is_student"
                />
                <Button
                  color="teal"
